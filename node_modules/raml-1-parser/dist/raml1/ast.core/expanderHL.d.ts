...
export declare class TraitsAndResourceTypesExpander {
    ...
    expandHighLevelNode(hlNode: hl.IHighLevelNode, rp: referencePatcher.ReferencePatcher, api: hl.IHighLevelNode, forceExpand?: boolean, initTypes?: boolean): hl.IHighLevelNode;
