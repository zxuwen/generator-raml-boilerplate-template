...
var NamespaceResolver = (function () {
    ...
    NamespaceResolver.prototype.unitModel = function (unit) {
        ...
        if (result.isOverlayOrExtension()) {
            var rootNode = unit.ast();
            var extendsAttrs = rootNode.children().filter(function (x) {
            ...
            if (extendsAttrs.length > 0) {
                ...
                if (eVal) {
                    var masterUnit = unit.resolve(eVal);
                    if (masterUnit) {
                        var masterUnitModel = this.unitModel(masterUnit);
