...
var TraitsAndResourceTypesExpander = (function () {
    function TraitsAndResourceTypesExpander() {
        this.hasGlobalTraits = false;
        this.hasGlobalResourceTypes = false;
    }
    TraitsAndResourceTypesExpander.prototype.expandTraitsAndResourceTypes = function (api, rp, forceProxy) {
        ...
        var result = this.expandHighLevelNode(hlNode, rp, api, true);
        return result;
    };
    ...
    TraitsAndResourceTypesExpander.prototype.expandHighLevelNode = function (hlNode, rp, api, initTypes) {
        var _this = this;
    ...
    TraitsAndResourceTypesExpander.prototype.processResource = function (resource, _nodes) {
        ...
        resource.methods()
            .forEach(function (x) { return _this.mergeBodiesForMethod(x.highLevel()); });
    };
...
var LibraryExpander = (function () {
    ...
    LibraryExpander.prototype.expandLibrary = function (_lib) {
        ...
        if (proxy.LowLevelCompositeNode.isInstance(lib.highLevel().lowLevel())) {
            lib = lib.highLevel().lowLevel().unit().highLevel().asElement().wrapperNode();
        }
        var expander = new TraitsAndResourceTypesExpander();
        var rp = new referencePatcher.ReferencePatcher();
        var hlNode = expander.createHighLevelNode(lib.highLevel(), true, rp, true);
        rp.process(hlNode);
