 ...
 */
export declare function isParameter(node: core.AbstractWrapperNode): node is Parameter;
/**
 ...
 */
export declare function isParameterLocation(node: core.AbstractWrapperNode): node is ParameterLocation;
/**
 ...
 */
export declare function isBodyLike(node: core.AbstractWrapperNode): node is BodyLike;
/**
 ...
 */
export declare function isJSONExample(node: core.AbstractWrapperNode): node is JSONExample;
/**
 ...
 */
export declare function isXMLExample(node: core.AbstractWrapperNode): node is XMLExample;
/**
 ...
 */
export declare function isXMLBody(node: core.AbstractWrapperNode): node is XMLBody;
/**
 ...
 */
export declare function isJSONBody(node: core.AbstractWrapperNode): node is JSONBody;
/**
 ...
 */
export declare function isFixedUri(node: core.AbstractWrapperNode): node is FixedUri;
/**
