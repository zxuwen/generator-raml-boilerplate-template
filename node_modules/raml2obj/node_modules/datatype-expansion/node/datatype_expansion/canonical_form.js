...
var pred__15887 = cljs.core.count.call(null,values);
var expr__15888 = cljs.core._EQ_;
if(cljs.core.truth_(pred__15887.call(null,(0),expr__15888))){
return null;
} else {
if(cljs.core.truth_(pred__15887.call(null,(1),expr__15888))){
return cljs.core.first.call(null,values);
} else {
if(cljs.core.truth_(pred__15887.call(null,(2),expr__15888))){
if(cljs.core._EQ_.call(null,super$,sub)){
return super$;
} else {
...
throw (new Error([cljs.core.str("No matching clause: "),cljs.core.str(expr__15888)].join('')));
}
}
}
}));
...
var values = cljs.core.filter.call(null,cljs.core.some_QMARK_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [super$,sub], null));
var pred__15890 = cljs.core.count.call(null,values);
var expr__15891 = cljs.core._EQ_;
if(cljs.core.truth_(pred__15890.call(null,(0),expr__15891))){
return null;
} else {
if(cljs.core.truth_(pred__15890.call(null,(1),expr__15891))){
return cljs.core.first.call(null,values);
} else {
if(cljs.core.truth_(pred__15890.call(null,(2),expr__15891))){
if(cljs.core._EQ_.call(null,super$,sub)){
return super$;
} else {
...
throw (new Error([cljs.core.str("No matching clause: "),cljs.core.str(expr__15891)].join('')));
}
}
}
}));
...
var values = cljs.core.filter.call(null,cljs.core.some_QMARK_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [super$,sub], null));
var pred__15893 = cljs.core.count.call(null,values);
var expr__15894 = cljs.core._EQ_;
if(cljs.core.truth_(pred__15893.call(null,(0),expr__15894))){
return null;
} else {
if(cljs.core.truth_(pred__15893.call(null,(1),expr__15894))){
return cljs.core.first.call(null,values);
} else {
if(cljs.core.truth_(pred__15893.call(null,(2),expr__15894))){
if(cljs.core._EQ_.call(null,super$,sub)){
return super$;
} else {
...
throw (new Error([cljs.core.str("No matching clause: "),cljs.core.str(expr__15894)].join('')));
}
}
}
}));
...
var values = cljs.core.filter.call(null,cljs.core.some_QMARK_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [super$,sub], null));
var pred__15896 = cljs.core.count.call(null,values);
var expr__15897 = cljs.core._EQ_;
if(cljs.core.truth_(pred__15896.call(null,(0),expr__15897))){
return null;
} else {
if(cljs.core.truth_(pred__15896.call(null,(1),expr__15897))){
return cljs.core.first.call(null,values);
} else {
if(cljs.core.truth_(pred__15896.call(null,(2),expr__15897))){
if(cljs.core._EQ_.call(null,super$,sub)){
return super$;
} else {
...
throw (new Error([cljs.core.str("No matching clause: "),cljs.core.str(expr__15897)].join('')));
}
}
}
}));
...
var G__15899 = cljs.core.assoc.call(null,merged,property,(function (){var or__6216__auto__ = property_super;
if(cljs.core.truth_(or__6216__auto__)){
return or__6216__auto__;
} else {
return property_sub;
...
var G__15900 = cljs.core.rest.call(null,properties);
merged = G__15899;
properties = G__15900;
continue;
} else {
var G__15901 = cljs.core.assoc.call(null,merged,property,datatype_expansion.canonical_form.lt_restriction.call(null,property,property_super,property_sub));
var G__15902 = cljs.core.rest.call(null,properties);
merged = G__15901;
properties = G__15902;
continue;
}
...
datatype_expansion.canonical_form.consistency_checks = new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"numProperties","numProperties",-85472948),(function (p__15903){
var map__15904 = p__15903;
var map__15904__$1 = ((((!((map__15904 == null)))?((((map__15904.cljs$lang$protocol_mask$partition0$ & (64))) || (map__15904.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__15904):map__15904);
var minProperties = cljs.core.get.call(null,map__15904__$1,new cljs.core.Keyword(null,"minProperties","minProperties",100355152));
var maxProperties = cljs.core.get.call(null,map__15904__$1,new cljs.core.Keyword(null,"maxProperties","maxProperties",1289793027));
...
}),new cljs.core.Keyword(null,"length","length",588987862),(function (p__15906){
var map__15907 = p__15906;
var map__15907__$1 = ((((!((map__15907 == null)))?((((map__15907.cljs$lang$protocol_mask$partition0$ & (64))) || (map__15907.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__15907):map__15907);
var minLength = cljs.core.get.call(null,map__15907__$1,new cljs.core.Keyword(null,"minLength","minLength",-1538722770));
var maxLength = cljs.core.get.call(null,map__15907__$1,new cljs.core.Keyword(null,"maxLength","maxLength",-1633020073));
...
}),new cljs.core.Keyword(null,"size","size",1098693007),(function (p__15909){
...
var minimum = cljs.core.get.call(null,map__15910__$1,new cljs.core.Keyword(null,"minimum","minimum",-1621006059));
var maximum = cljs.core.get.call(null,map__15910__$1,new cljs.core.Keyword(null,"maximum","maximum",573880714));
...
}),new cljs.core.Keyword(null,"numItems","numItems",-1505478382),(function (p__15912){
...
var minItems = cljs.core.get.call(null,map__15913__$1,new cljs.core.Keyword(null,"minItems","minItems",1950622069));
var maxItems = cljs.core.get.call(null,map__15913__$1,new cljs.core.Keyword(null,"maxItems","maxItems",576652798));
...
var seq__15921_15927 = cljs.core.seq.call(null,datatype_expansion.canonical_form.consistency_checks);
var chunk__15922_15928 = null;
var count__15923_15929 = (0);
var i__15924_15930 = (0);
while(true){
if((i__15924_15930 < count__15923_15929)){
var vec__15925_15931 = cljs.core._nth.call(null,chunk__15922_15928,i__15924_15930);
var name_15932 = cljs.core.nth.call(null,vec__15925_15931,(0),null);
var check_fn_15933 = cljs.core.nth.call(null,vec__15925_15931,(1),null);
check_fn_15933.call(null,merged);

var G__15934 = seq__15921_15927;
var G__15935 = chunk__15922_15928;
var G__15936 = count__15923_15929;
var G__15937 = (i__15924_15930 + (1));
seq__15921_15927 = G__15934;
chunk__15922_15928 = G__15935;
count__15923_15929 = G__15936;
i__15924_15930 = G__15937;
continue;
} else {
var temp__4657__auto___15938 = cljs.core.seq.call(null,seq__15921_15927);
if(temp__4657__auto___15938){
var seq__15921_15939__$1 = temp__4657__auto___15938;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__15921_15939__$1)){
var c__7027__auto___15940 = cljs.core.chunk_first.call(null,seq__15921_15939__$1);
var G__15941 = cljs.core.chunk_rest.call(null,seq__15921_15939__$1);
var G__15942 = c__7027__auto___15940;
var G__15943 = cljs.core.count.call(null,c__7027__auto___15940);
var G__15944 = (0);
seq__15921_15927 = G__15941;
chunk__15922_15928 = G__15942;
count__15923_15929 = G__15943;
i__15924_15930 = G__15944;
continue;
} else {
var vec__15926_15945 = cljs.core.first.call(null,seq__15921_15939__$1);
var name_15946 = cljs.core.nth.call(null,vec__15926_15945,(0),null);
var check_fn_15947 = cljs.core.nth.call(null,vec__15926_15945,(1),null);
check_fn_15947.call(null,merged);

var G__15948 = cljs.core.next.call(null,seq__15921_15939__$1);
var G__15949 = null;
var G__15950 = (0);
var G__15951 = (0);
seq__15921_15927 = G__15948;
chunk__15922_15928 = G__15949;
count__15923_15929 = G__15950;
i__15924_15930 = G__15951;
continue;
}
} else {
}
...
var type = cljs.core.get.call(null,map__15954__$1,new cljs.core.Keyword(null,"type","type",1174270348));
...
return cljs.core.assoc.call(null,type,new cljs.core.Keyword(null,"properties","properties",685819552),p1__15958_SHARP_);
...
return cljs.core.assoc.call(null,properties,property_name,p1__15957_SHARP_);
});})(properties,required,union_values))
,cljs.core.mapv.call(null,((function (properties,required,union_values){
return (function (p1__15956_SHARP_){
return cljs.core.assoc.call(null,p1__15956_SHARP_,new cljs.core.Keyword(null,"required","required",1807647006),required);
});})(properties,required,union_values))
,union_values)));
}),accum));
});
...
return (function (p__15959){
var vec__15960 = p__15959;
var property_name = cljs.core.nth.call(null,vec__15960,(0),null);
var property_value = cljs.core.nth.call(null,vec__15960,(1),null);
...
var vec__15961 = cljs.core.first.call(null,properties__$2);
var name = cljs.core.nth.call(null,vec__15961,(0),null);
var value = cljs.core.nth.call(null,vec__15961,(1),null);
...
var G__15962 = cljs.core.rest.call(null,properties__$2);
var G__15963 = datatype_expansion.canonical_form.expand_property.call(null,accum__$1,name,canonical_value);
properties__$2 = G__15962;
accum__$1 = G__15963;
continue;
} else {
var G__15964 = cljs.core.rest.call(null,properties__$2);
var G__15965 = datatype_expansion.canonical_form.append_property.call(null,accum__$1,name,canonical_value);
properties__$2 = G__15964;
accum__$1 = G__15965;
continue;
}
}
...
var type = cljs.core.first.call(null,cljs.core.filter.call(null,cljs.core.some_QMARK_,cljs.core.map.call(null,(function (p1__15966_SHARP_){
try{return datatype_expansion$canonical_form$find_class.call(null,p1__15966_SHARP_);
}catch (e15968){if((e15968 instanceof Error)){
var ex = e15968;
return null;
} else {
throw e15968;
...
var sub_type__$1 = (function (){var pred__15969 = cljs.core._EQ_;
var expr__15970 = super_type_class;
if(cljs.core.truth_(pred__15969.call(null,"array",expr__15970))){
...
if(cljs.core.truth_(pred__15969.call(null,"object",expr__15970))){
...
if(cljs.core.truth_(pred__15969.call(null,"union",expr__15970))){
...
var super_type_class = datatype_expansion.canonical_form.find_class.call(null,node);
var sub_type = cljs.core.assoc.call(null,node,new cljs.core.Keyword(null,"type","type",1174270348),super_type_class);
var sub_type__$1 = (function (){var pred__15972 = cljs.core._EQ_;
var expr__15973 = super_type_class;
if(cljs.core.truth_(pred__15972.call(null,"array",expr__15973))){
return cljs.core.assoc.call(null,sub_type,new cljs.core.Keyword(null,"items","items",1031954938),cljs.core.get.call(null,sub_type,new cljs.core.Keyword(null,"items","items",1031954938),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"type","type",1174270348),"any"], null)));
} else {
if(cljs.core.truth_(pred__15972.call(null,"object",expr__15973))){
...
if(cljs.core.truth_(pred__15972.call(null,"union",expr__15973))){
return cljs.core.assoc.call(null,sub_type,new cljs.core.Keyword(null,"anyOf","anyOf",-1046092155),cljs.core.get.call(null,sub_type,new cljs.core.Keyword(null,"anyOf","anyOf",-1046092155),cljs.core.PersistentVector.EMPTY));
} else {
return sub_type;
}
...
return datatype_expansion.canonical_form.canonical_form.call(null,datatype_expansion.canonical_form.consistency_check.call(null,cljs.core.reduce.call(null,((function (super_type_class,sub_type,sub_type__$1){
return (function (acc,super_type){
return datatype_expansion.canonical_form.lt.call(null,datatype_expansion.canonical_form.canonical_form.call(null,super_type),acc);
...
//# sourceMappingURL=canonical_form.js.map?rel=1478089868385