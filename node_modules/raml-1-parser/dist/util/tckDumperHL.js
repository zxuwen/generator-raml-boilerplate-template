...
var helpersHL = require("../raml1/wrapped-ast/helpersHL");
...
var TCKDumper = (function () {
    ...
    TCKDumper.prototype.init = function (node) {
        this.helpersMap = {
    ...
    TCKDumper.prototype.dispose = function () {
    ...
    TCKDumper.prototype.dumpInternal = function (_node, nodeProperty, rp, meta, isRoot) {
        var _this = this;
        ...
        if (_node.isElement()) {
            ...
            if (universeHelpers.isExampleSpecType(definition)) {
                if (eNode.parent() != null) {
                    ...
                    var eObj = helpersHL.dumpExpandableExample(at.examples()[0], this.options.dumpXMLRepresentationOfExamples);
    ...
    TCKDumper.prototype.getDefaultsCalculator = function () {
    ...
    TCKDumper.prototype.serializeMeta = function (obj, node, _meta) {
        if (!this.options.serializeMetadata) {
            return;
        }
        var definition = node.definition();
    ...
    TCKDumper.prototype.applyHelpers = function (pVal, node, p, serializeMetadata) {
        var pName = p.nameId();
...
var TypeTransformer = (function (_super) {
    ...
    TypeTransformer.prototype.transform = function (_value, node) {
        ...
        var exampleObj = helpersHL.typeExample(node.asElement(), this.options.dumpXMLRepresentationOfExamples);
        if (exampleObj) {
            value["examples"] = [exampleObj];
        }
        else {
            var examples = helpersHL.typeExamples(node.asElement(), this.options.dumpXMLRepresentationOfExamples);
...
//# sourceMappingURL=tckDumperHL.js.map