...
var TypeDeclarationValidator = (function () {
    ...
    TypeDeclarationValidator.prototype.validate = function (node, v) {
        ...
        if (examplesLowLevel && examplesLowLevel.valueKind && examplesLowLevel.valueKind() === yaml.Kind.SEQ) {
            var issue = createLLIssue1(messageRegistry.MAP_EXPECTED, {}, examplesLowLevel, node, false);
            v.accept(issue);
        }
            ...
            if (mediaType) {
                if (isJson(mediaType)) {
                    try {
                        ...
                        if (ValidationError.isInstance(e)) {
                            if (!checkIfIncludeTagIsMissing(node, cb, e.messageEntry.code, !strictValidation)) {
                                cb.accept(createIssue2(e, node, !strictValidation));
                            }
                        }
                        else {
...
var offsetRegexp = /^[ ]*/;
var localError = function (node, c, w, message, p, prop, positionsSource, internalRange, forceScalar) {
    ...
    if (internalRange && (valueKind == yaml.Kind.SCALAR || forceScalar)) {
        if (vk1 == yaml.Kind.INCLUDE_REF) {
            ...
            if (includedUnit) {
                ...
                var trace = localError(node, c, w, message, p, prop, positionsSource);
...
var localLowLevelError = function (node, highLevelAnchor, issueCode, isWarning, message, path, range) {
...
function createIssue(issueCode, message, node, isWarning, internalRange, forceScalar) {
    if (isWarning === void 0) { isWarning = false; }
    if (forceScalar === void 0) { forceScalar = false; }
